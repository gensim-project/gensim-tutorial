...
\begin{frame}{A More Complicated Bank}

\centering
\only<1>{\includegraphics{figures/regbank-fp}}
\only<2>{\includegraphics{figures/regbank-fp-dp}}
\only<3>{\includegraphics{figures/regbank-fp-q}}
